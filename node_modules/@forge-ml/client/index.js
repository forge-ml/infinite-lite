...
export var createRequest = function (params) {
    return function (query, opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("".concat(serverUrl, "/q/").concat(params.username, "/").concat(params.path), {
                            method: "POST",
                            headers: __assign({ "Content-Type": "application/json", Authorization: "Bearer ".concat(opts.token) }, (opts.cache && {
